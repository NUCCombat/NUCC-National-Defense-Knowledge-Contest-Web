	...
	methods: {
    	...
    	save: function (){
            ...
            $.ajax({
					...
					type: "POST",
					url: httpurl+'completion/'+this.msg,
			    	data: {COMPLETION_ID:this.COMPLETION_ID,
				    TITLE:this.pd.TITLE,
    	...
    	getData: function(){
            ...
            $.ajax({
				...
				type: "POST",
				url: httpurl+'completion/goEdit',
		    	data: {COMPLETION_ID:this.COMPLETION_ID,tm:new Date().getTime()},
				dataType:"json",
				success: function(data){
                     if("success" == data.result){
                     	vm.pd = data.pd;							//参数map
