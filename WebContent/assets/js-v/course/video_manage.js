	...
	methods: {
    	...
    	viewDx: function(VIDEO_ID){
            ...
            $.ajax({
		    	...
		    	data: {VIDEO_ID:VIDEO_ID,tm:new Date().getTime()},
				dataType:"json",
				success: function(data){
                     if("success" == data.result){
    	...
    	goAdd: function (){
    		 ...
    		 diag.Drag=true;
    		 diag.Title ="新增";
    		 diag.URL = '../../course/video/video_edit.html';
    		 diag.Width = 1000;
    		 diag.Height = 390;
    		 diag.Modal = true;				//有无遮罩窗口
    	...
    	goEdit: function(id){
    		 ...
    		 diag.Drag=true;
    		 diag.Title ="编辑";
    		 diag.URL = '../../course/video/video_edit.html?FID='+id;
    		 diag.Width = 1000;
    		 diag.Height = 358;
    		 diag.Modal = true;				//有无遮罩窗口
    		 diag. ShowMaxButton = true;	//最大化按钮
    		...
    		swal({
                ...
                if (willDelete) {
                	...
                	$.ajax({
            			...
            			type: "POST",
            			url: httpurl+'video/delete',
            	    	data: {VIDEO_ID:id,VIDEOPATH:VIDEOPATH,tm:new Date().getTime()},
            			dataType:'json',
            			success: function(data){
            				 if("success" == data.result){
    	...
    	getDic: function(){
      	...
      	//判断按钮权限，用于是否显示按钮
        hasButton: function(){
        	var keys = 'video:add,video:del,video:edit';
        	$.ajax({
        		xhrFields: {
                    withCredentials: true
                },
        		...
        		success: function(data){
        		 if("success" == data.result){
        			vm.add = data.videofhadminadd;		//新增权限
        			vm.del = data.videofhadmindel;		//删除权限
        			vm.edit = data.videofhadminedit;	//修改权限
        		 }else if ("exception" == data.result){
